...
const BubbleChartPage = () => {
  ...
  return (
    <Container>
      ...
      <Description>
        This bubble chart visualizes the relationship between countries' population sizes 
        and COVID-19 impact. Each bubble represents a country, with size proportional to 
        population and color indicating continent. Hover over bubbles to see more details.
      </Description>
